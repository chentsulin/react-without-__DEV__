...
(function (scope) {
  ...
  var script = document.querySelector('script[src*="' + "webcomponents.js" + '"]');
  var flags = {};
  if (!flags.noOpts) {
...
if (WebComponents.flags.shadow) {
  ...
  (function (scope) {
    ...
    scope.defineWrapGetter = function (constructor, name) {
      defineGetter(constructor, name, function () {
        return wrap(this.__impl4cf1e782hg__[name]);
      });
    };
    scope.forwardMethodsToWrapper = function (constructors, names) {
    ...
    scope.isWrapperFor = function (wrapperConstructor, nativeConstructor) {
      return constructorTable.get(nativeConstructor.prototype) === wrapperConstructor;
    };
    scope.mixin = function (to, from) {
      var names = getOwnPropertyNames(from);
      for (var i = 0; i < names.length; i++) {
        var name = names[i];
        defineProperty(to, name, getOwnPropertyDescriptor(from, name));
    ...
    scope.oneOf = function (object, propertyNames) {
      for (var i = 0; i < propertyNames.length; i++) {
        if (propertyNames[i] in object) return propertyNames[i];
      }
    };
    scope.registerObject = function (object) {
    ...
    scope.registerWrapper = function (nativeConstructor, wrapperConstructor, opt_instance) {
      var nativePrototype = nativeConstructor.prototype;
      registerInternal(nativePrototype, wrapperConstructor, opt_instance);
      mixinStatics(wrapperConstructor, nativeConstructor);
    };
    scope.rewrap = function (node, wrapper) {
      if (wrapper === null) return;
      assert(isNative(node));
      assert(wrapper === undefined || isWrapper(wrapper));
      node.__wrapper8e3dd93a60__ = wrapper;
    };
    scope.setWrapper = function (impl, wrapper) {
      wrapper.__impl4cf1e782hg__ = impl;
      impl.__wrapper8e3dd93a60__ = wrapper;
    };
    scope.unsafeUnwrap = function (wrapper) {
      return wrapper.__impl4cf1e782hg__;
    };
    scope.unwrap = unwrap;
    scope.unwrapIfNeeded = function (object) {
  ...
  (function (context) {
    ...
    context.setEndOfMicrotask = function (func) {
      callbacks.push(func);
      if (pending) return;
      pending = true;
      timerFunc(handle, 0);
  ...
  (function (scope) {
    ...
    scope.enqueueMutation = function (target, type, data) {
    ...
    scope.registerTransientObservers = function (ancestor, node) {
  ...
  (function (scope) {
    ...
    function dispatchAtTarget(event, eventPath, win, overrideTarget) {
      ...
      return invoke(currentTarget, event, AT_TARGET, eventPath, overrideTarget);
    }
    ...
    scope.elementFromPoint = function (self, document, x, y) {
      scope.renderAllPending();
    ...
    scope.getEventHandlerGetter = function (name) {
      return function () {
        var inlineEventHandlers = eventHandlersTable.get(this);
        return inlineEventHandlers && inlineEventHandlers[name] && inlineEventHandlers[name].value || null;
      };
    };
    scope.getEventHandlerSetter = function (name) {
    ...
    scope.wrapEventTargetMethods = function (constructors) {
  ...
  (function (scope) {
    ...
    scope.addWrapNodeListMethod = function (wrapperConstructor, name) {
  ...
  (function (scope) {
    ...
    OriginalNode.prototype.appendChild;
  ...
  (function (scope) {
    ...
    function matchesTagName(el, localName, localNameLowerCase) {
      var ln = el.localName;
      return ln === localName || ln === localNameLowerCase && el.namespaceURI === "http://www.w3.org/1999/xhtml";
    }
  ...
  (function (scope) {
    ...
    function setInnerHTML(node, value, opt_tagName) {
      node.textContent = "";
      var tempElement = unwrap(node.ownerDocument.createElement(opt_tagName || "div"));
    ...
    ["clientHeight", "clientLeft", "clientTop", "clientWidth", "offsetHeight", "offsetLeft", "offsetTop", "offsetWidth", "scrollHeight", "scrollWidth"].forEach(function (name) {
    ...
    ["getBoundingClientRect", "getClientRects", "scrollIntoView"].forEach(function (name) {
      Object.defineProperty(HTMLElement.prototype, name, {
        value: function () {
          scope.renderAllPending();
  ...
  (function (scope) {
    ...
    ShadowRenderer.prototype = {
      render: function (opt_renderNode) {
        ...
        if (!opt_renderNode) renderNode.sync();
        this.dirty = false;
      },
      get parentRenderer() {
  ...
  (function (scope) {
    ...
    ["HTMLButtonElement", "HTMLFieldSetElement", "HTMLInputElement", "HTMLKeygenElement", "HTMLLabelElement", "HTMLLegendElement", "HTMLObjectElement", "HTMLOutputElement", "HTMLTextAreaElement"].forEach(function (name) {
  ...
  (function (scope) {
    ...
    ["createComment", "createDocumentFragment", "createElement", "createElementNS", "createEvent", "createEventNS", "createRange", "createTextNode", "getElementById"].forEach(function (name) {
    ...
    if (document.registerElement) {
      ...
      Document.prototype.registerElement = function (tagName, object) {
        ...
        originalRegisterElement.call(unwrap(this), tagName, p);
    ...
    if (window.ShadowDOMPolyfill) {
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        if (window.HTMLImports && !HTMLImports.useNative) {
          ...
          HTMLImports.parser.documentSelectors = [HTMLImports.parser.documentSelectors, SHIM_SHEET_SELECTOR, "style[" + SHIM_ATTRIBUTE + "]"].join(",");
...
HTMLImports.addModule(function (scope) {
  ...
  var importParser = {
    ...
    parseScript: function (scriptElt) {
      ...
      this.trackElement(script, function () {
...
CustomElements.addModule(function (scope) {
  ...
  scope.forDocumentTree = function (doc, cb) {
    processingDocuments = [];
...
CustomElements.addModule(function (scope) {
  ...
  scope.watchShadow = function (node) {
  ...
  scope.upgradeDocumentTree = function (doc) {
    forDocumentTree(doc, upgradeDocument);
  };
  scope.upgradeSubtree = addedSubtree;
  scope.upgradeAll = addedNode;
  scope.attachedNode = function (node) {
    attached(node);
    if (inDocument(node)) {
      forSubtree(node, function (e) {
        attached(e);
  ...
  scope.takeRecords = function (node) {
    node = wrap(node);
    if (!node) {
      node = wrap(document);
    }
...
CustomElements.addModule(function (scope) {
  ...
  document.createElementNS = function (namespace, tag, typeExtension) {
