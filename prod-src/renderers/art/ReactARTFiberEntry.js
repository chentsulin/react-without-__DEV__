...
class Surface extends Component {
  ...
  render() {
    ...
    return <Tag ref={ref => this._tagRef = ref} accessKey={props.accessKey} className={props.className} draggable={props.draggable} role={props.role} style={props.style} tabIndex={props.tabIndex} title={props.title} />;
  }
}
...
class Text extends React.Component {
  ...
  render() {
    ...
    const T = TYPES.TEXT;
    return <T {...this.props} ref={t => this._text = t}>
