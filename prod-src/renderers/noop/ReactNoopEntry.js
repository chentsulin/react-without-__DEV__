...
var ReactNoop = {
  ...
  flushDeferredPri(timeout: number = Infinity): Array<mixed> {
    ...
    for (const value of flushUnitsOfWork(timeout / 5 - 1)) {
      values.push(...value);
    }
    return values;
  },
  ...
  flushAndYield(unitsOfWork: number = Infinity): Generator<Array<mixed>, void, void> {
  ...
  dumpTree(rootID: string = DEFAULT_ROOT_ID) {
    ...
    log('HOST INSTANCES:');
    (function (container: Container, depth) {
