...
var ReactOwner = {
   ...
   * @internal
   */
  addComponentAsRefTo: function (component: ReactInstance, ref: string, owner: ReactInstance | Fiber): void {
   ...
   * @internal
   */
  removeComponentAsRefFrom: function (component: ReactInstance, ref: string, owner: ReactInstance | Fiber): void {
    if (owner && (owner: any).tag === ClassComponent) {
      const inst = (owner: any).stateNode;
