...
var { ReactDebugCurrentFrame }, ReactDebugCurrentStack, warningAboutMissingGetChildContext;
...
var ReactCompositeComponent = {
  ...
  performInitialMount: function (renderedElement, hostParent, hostContainerInfo, transaction, context) {
    ...
    var markup = ReactReconciler.mountComponent(child, transaction, hostParent, hostContainerInfo, this._processChildContext(context), 0);
  ...
  _processPendingState: function (props, context) {
    ...
    for (var i = replace ? 1 : 0; i < queue.length; i++) {
      var partial = queue[i];
      let partialState = typeof partial === 'function' ? partial.call(inst, nextState, props, context) : partial;
      if (partialState) {
        if (dontMutate) {
          dontMutate = false;
  ...
  _updateRenderedComponentWithNextElement: function (transaction, context, nextRenderedElement, safely) {
    ...
    if (shouldUpdateReactComponent(prevRenderedElement, nextRenderedElement)) {
      ...
      var nextMarkup = ReactReconciler.mountComponent(child, transaction, this._hostParent, this._hostContainerInfo, this._processChildContext(context), 0);
  ...
  _renderValidatedComponent: function () {
    var renderedElement;
    if (false || this._compositeType !== ReactCompositeComponentTypes.StatelessFunctional) {
    ...
    renderedElement === null || renderedElement === false || React.isValidElement(renderedElement), '%s.render(): A valid React element (or null) must be returned. You may have ' + 'returned undefined, an array or some other invalid object.', this.getName() || 'ReactCompositeComponent');
