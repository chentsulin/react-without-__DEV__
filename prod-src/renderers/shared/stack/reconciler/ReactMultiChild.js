...
var { ReactDebugCurrentFrame }, ReactDebugCurrentStack;
...
var ReactMultiChild = {
  ...
  _reconcilerUpdateChildren: function (prevChildren, nextNestedChildrenElements, mountImages, removedNodes, transaction, context) {
    ...
    nextChildren = flattenStackChildren(nextNestedChildrenElements, selfDebugID);
   ...
   * @private
   */
  _mountChildAtIndex: function (child, mountImage, afterNode, index) {
    child._mountIndex = index;
