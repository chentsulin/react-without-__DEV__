...
var ReactDebugCurrentFiber, { cancelWorkTimer }, warning, warnedAboutStatelessRefs;


module.exports = function <T, P, I, TI, PI, C, CX, PL>(config: HostConfig<T, P, I, TI, PI, C, CX, PL>, hostContext: HostContext<C, CX>, hydrationContext: HydrationContext<C>, scheduleUpdate: (fiber: Fiber, priorityLevel: PriorityLevel) => void, getPriorityContext: (fiber: Fiber, forceAsync: boolean) => PriorityLevel) {
  const {
  ...
  function updateFunctionalComponent(current, workInProgress) {
    ...
    var nextChildren = fn(nextProps, context);
  ...
  function finishClassComponent(current: Fiber | null, workInProgress: Fiber, shouldUpdate: boolean, hasContext: boolean) {
  ...
  function updateHostRoot(current, workInProgress, priorityLevel) {
    ...
    if (updateQueue !== null) {
      ...
      const state = beginUpdateQueue(current, workInProgress, updateQueue, null, prevState, null, priorityLevel);
      if (prevState === state) {
  ...
  function updateHostComponent(current, workInProgress, renderPriority) {
    ...
    if (renderPriority !== OffscreenPriority && !useSyncScheduling && shouldDeprioritizeSubtree(type, nextProps)) {
  ...
  */
  ...
  return {
    beginWork: function (current: Fiber | null, workInProgress: Fiber, priorityLevel: PriorityLevel): Fiber | null {
    ...
    beginFailedWork: function (current: Fiber | null, workInProgress: Fiber, priorityLevel: PriorityLevel) {
