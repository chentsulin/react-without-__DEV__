...
import type { ReactCoroutine, ReactFragment, ReactPortal, ReactYield } from 'ReactTypes';
...
var getComponentName, hasBadMapPolyfill;
...
var createFiber = function (tag: TypeOfWork, key: null | string, internalContextTag: TypeOfInternalContext): Fiber {
...
exports.createWorkInProgress = function (current: Fiber, renderPriority: PriorityLevel): Fiber {
...
exports.createFiberFromElement = function (element: ReactElement, internalContextTag: TypeOfInternalContext, priorityLevel: PriorityLevel): Fiber {

  const fiber = createFiberFromElementType(element.type, element.key, internalContextTag, null);
...
exports.createFiberFromFragment = function (elements: ReactFragment, internalContextTag: TypeOfInternalContext, priorityLevel: PriorityLevel): Fiber {
...
exports.createFiberFromText = function (content: string, internalContextTag: TypeOfInternalContext, priorityLevel: PriorityLevel): Fiber {
...
function createFiberFromElementType(type: mixed, key: null | string, internalContextTag: TypeOfInternalContext): Fiber {
  let fiber;
  if (typeof type === 'function') {
    ...
    invariant(false, 'Element type is invalid: expected a string (for built-in components) ' + 'or a class/function (for composite components) but got: %s.%s', type == null ? type : typeof type, '');
  }
  return fiber;
}
...
exports.createFiberFromCoroutine = function (coroutine: ReactCoroutine, internalContextTag: TypeOfInternalContext, priorityLevel: PriorityLevel): Fiber {
...
exports.createFiberFromYield = function (yieldNode: ReactYield, internalContextTag: TypeOfInternalContext): Fiber {
  const fiber = createFiber(YieldComponent, null, internalContextTag);
  return fiber;
};

exports.createFiberFromPortal = function (portal: ReactPortal, internalContextTag: TypeOfInternalContext, priorityLevel: PriorityLevel): Fiber {
...
exports.largerPriority = function (p1: PriorityLevel, p2: PriorityLevel): PriorityLevel {
