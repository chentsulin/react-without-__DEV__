...
function insertUpdateIntoQueue(queue: UpdateQueue, update: Update, insertAfter: Update | null, insertBefore: Update | null) {
  if (insertAfter !== null) {
...
function insertUpdate(fiber: Fiber, update: Update): Update | null {
  ...
  const insertBefore1 = insertAfter1 !== null ? insertAfter1.next : queue1.first;
  ...
  const insertBefore2 = insertAfter2 !== null ? insertAfter2.next : queue2.first;
...
function addUpdate(fiber: Fiber, partialState: PartialState<any, any> | null, callback: mixed, priorityLevel: PriorityLevel): void {
  insertUpdate(fiber, {
    priorityLevel,
    partialState,
    callback,
...
function addReplaceUpdate(fiber: Fiber, state: any | null, callback: Callback | null, priorityLevel: PriorityLevel): void {
  insertUpdate(fiber, {
    priorityLevel,
    partialState: state,
    callback,
...
function addForceUpdate(fiber: Fiber, callback: Callback | null, priorityLevel: PriorityLevel): void {
  insertUpdate(fiber, {
    priorityLevel,
    partialState: null,
    callback,
...
function addTopLevelUpdate(fiber: Fiber, partialState: PartialState<any, any>, callback: Callback | null, priorityLevel: PriorityLevel): void {
...
function beginUpdateQueue(current: Fiber | null, workInProgress: Fiber, queue: UpdateQueue, instance: any, prevState: any, props: any, priorityLevel: PriorityLevel): any {
