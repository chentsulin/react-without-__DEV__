...
module.exports = function <T, P, I, TI, PI, C, CX, PL>(config: HostConfig<T, P, I, TI, PI, C, CX, PL>, hostContext: HostContext<C, CX>, hydrationContext: HydrationContext<C>) {
  const {
    createInstance,
    createTextInstance,
    appendInitialChild,
  ...
  return {
    completeWork: function (current: Fiber | null, workInProgress: Fiber, renderPriority: PriorityLevel): Fiber | null {

      // Get the latest props.
      let newProps = workInProgress.pendingProps;
      if (newProps === null) {
        newProps = workInProgress.memoizedProps;
      } else if (workInProgress.pendingWorkPriority !== OffscreenPriority || renderPriority === OffscreenPriority) {
