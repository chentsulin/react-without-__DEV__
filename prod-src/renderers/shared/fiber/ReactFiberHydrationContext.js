...
module.exports = function <T, P, I, TI, PI, C, CX, PL>(config: HostConfig<T, P, I, TI, PI, C, CX, PL>): HydrationContext<C> {
  const {
  ...
  return {
    enterHydrationState: function (fiber: Fiber) {
    ...
    tryToClaimNextHydratableInstance: function (fiber: Fiber) {
      if (!isHydrating) {
        return;
      }
      ...
      if (!canHydrate(fiber, nextInstance)) {
        ...
        deleteHydratableInstance((hydrationParentFiber: any), nextHydratableInstance);
      }
      fiber.stateNode = nextInstance;
      hydrationParentFiber = fiber;
      nextHydratableInstance = getFirstHydratableChild(nextInstance);
    },
    prepareToHydrateHostInstance: function (fiber: Fiber, rootContainerInstance: C): boolean {
      const instance: I = fiber.stateNode;
      const updatePayload = hydrateInstance(instance, fiber.type, fiber.memoizedProps, rootContainerInstance, fiber);
