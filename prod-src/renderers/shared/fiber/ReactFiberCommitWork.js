...
var { startPhaseTimer, stopPhaseTimer };


module.exports = function <T, P, I, TI, PI, C, CX, PL>(config: HostConfig<T, P, I, TI, PI, C, CX, PL>, captureError: (failedFiber: Fiber, error: mixed) => Fiber | null) {
  const {
    commitMount,
    commitUpdate,
    resetTextContent,
  ...
  return {
    commitPlacement: function (finishedWork: Fiber): void {
    ...
    commitDeletion: function (current: Fiber): void {
    ...
    commitWork: function (current: Fiber | null, finishedWork: Fiber): void {
    ...
    commitLifeCycles: function (current: Fiber | null, finishedWork: Fiber): void {
      switch (finishedWork.tag) {
        case ClassComponent:
          {
    ...
    commitAttachRef: function (finishedWork: Fiber) {
    ...
    commitDetachRef: function (current: Fiber) {
