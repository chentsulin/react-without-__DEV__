...
const NativeRenderer = ReactFiberReconciler({
  ...
  appendChildToContainer(parentInstance: Container, child: Instance | TextInstance): void {
    const childTag = typeof child === 'number' ? child : child._nativeTag;
  ...
  commitUpdate(instance: Instance, updatePayloadTODO: Object, type: string, oldProps: Props, newProps: Props): void {
    const viewConfig = instance.viewConfig;

    updateFiberProps(instance._nativeTag, newProps);

    const updatePayload = ReactNativeAttributePayload.diff(oldProps, newProps, viewConfig.validAttributes);
  ...
  createInstance(type: string, props: Props, rootContainerInstance: Container, hostContext: {}, internalInstanceHandle: Object): Instance {
  ...
  createTextInstance(text: string, rootContainerInstance: Container, hostContext: {}, internalInstanceHandle: Object): TextInstance {
    const tag = ReactNativeTagHandles.allocateTag();
  ...
  finalizeInitialChildren(parentInstance: Instance): boolean {
  ...
  insertBefore(parentInstance: Instance, child: Instance | TextInstance, beforeChild: Instance | TextInstance): void {
    ...
    if (index >= 0) {
      ...
      UIManager.manageChildren((parentInstance: any)._nativeTag, // containerID
      [index], // moveFromIndices
  ...
  insertInContainerBefore(parentInstance: Container): void {
  ...
  removeChildFromContainer(parentInstance: Container, child: Instance | TextInstance): void {
    recursivelyUncacheFiberNode(child);
