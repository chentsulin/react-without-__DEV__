...
const findNumericNodeHandle = ReactNativeFeatureFlags.useFiber ? require('findNumericNodeHandleFiber') : require('findNumericNodeHandleStack');
 ...
 * @abstract
 */
class ReactNativeComponent<DefaultProps, Props, State> extends React.Component<DefaultProps, Props, State> {
...
function setNativePropsStack(componentOrHandle: any, nativeProps: Object) {
  ...
  const tag: number = typeof maybeInstance.getHostNode === 'function' ? maybeInstance.getHostNode() : maybeInstance._rootNodeID;
...
let injectedSetNativeProps: (componentOrHandle: any, nativeProps: Object) => void;
