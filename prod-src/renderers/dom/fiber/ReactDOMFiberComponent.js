...
var warning, ReactDOMInvalidARIAHook, ReactDOMNullInputValuePropHook, ReactDOMUnknownPropertyHook, { validateProperties: validateARIAProperties }, {
...
var warnedUnknownTags, validatePropertiesInDevelopment, warnForTextDifference, warnForPropDifference, warnForExtraAttributes, testDocument, normalizeHTML;
...
function setInitialDOMProperties(domElement: Element, rootContainerElement: Element | Document, nextProps: Object, isCustomComponentTag: boolean): void {
...
var ReactDOMFiberComponent = {
  ...
  createElement(type: *, props: Object, rootContainerElement: Element | Document, parentNamespace: string): Element {
    // We create tags in the namespace of their parent container, except HTML
    var ownerDocument: Document = rootContainerElement.nodeType === DOCUMENT_NODE ? (rootContainerElement: any) : rootContainerElement.ownerDocument;
  ...
  setInitialProperties(domElement: Element, tag: string, rawProps: Object, rootContainerElement: Element | Document): void {
  ...
  diffProperties(domElement: Element, tag: string, lastRawProps: Object, nextRawProps: Object, rootContainerElement: Element | Document): null | Array<mixed> {
  ...
  // Apply the diff.
  updateProperties(domElement: Element, updatePayload: Array<any>, tag: string, lastRawProps: Object, nextRawProps: Object): void {
  ...
  diffHydratedProperties(domElement: Element, tag: string, rawProps: Object, rootContainerElement: Element | Document): null | Array<mixed> {
