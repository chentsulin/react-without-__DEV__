...
var lowPriorityWarning, warning, validateDOMNesting, { updatedAncestorInfo };
...
var DOMRenderer = ReactFiberReconciler({
  getRootHostContext(rootContainerInstance: Container): HostContext {
    ...
    if (rootContainerInstance.nodeType === DOCUMENT_NODE) {
      ...
      const container: any = rootContainerInstance.nodeType === COMMENT_NODE ? rootContainerInstance.parentNode : rootContainerInstance;
  ...
  createInstance(type: string, props: Props, rootContainerInstance: Container, hostContext: HostContext, internalInstanceHandle: Object): Instance {
    let parentNamespace: string = ((hostContext: any): HostContextProd);
  ...
  finalizeInitialChildren(domElement: Instance, type: string, props: Props, rootContainerInstance: Container): boolean {
    setInitialProperties(domElement, type, props, rootContainerInstance);
    return shouldAutoFocusHostComponent(type, props);
  },

  prepareUpdate(domElement: Instance, type: string, oldProps: Props, newProps: Props, rootContainerInstance: Container): null | Array<mixed> {
    return diffProperties(domElement, type, oldProps, newProps, rootContainerInstance);
  },

  commitMount(domElement: Instance): void {
    ((domElement: any): HTMLButtonElement | HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement).focus();
  },

  commitUpdate(domElement: Instance, updatePayload: Array<mixed>, type: string, oldProps: Props, newProps: Props): void {
  ...
  canHydrateInstance(instance: Instance | TextInstance, type: string): boolean {
    return instance.nodeType === ELEMENT_NODE && type === instance.nodeName.toLowerCase();
  },

  canHydrateTextInstance(instance: Instance | TextInstance, text: string): boolean {
    if (text === '') {
  ...
  getNextHydratableSibling(instance: Instance | TextInstance): null | Instance | TextInstance {
  ...
  getFirstHydratableChild(parentInstance: Container | Instance): null | Instance | TextInstance {
  ...
  hydrateInstance(instance: Instance, type: string, props: Props, rootContainerInstance: Container, internalInstanceHandle: Object): null | Array<mixed> {
  ...
  hydrateTextInstance(textInstance: TextInstance, text: string, internalInstanceHandle: Object): boolean {
    precacheFiberNode(internalInstanceHandle, textInstance);
    return diffHydratedText(textInstance, text);
  },

  didNotHydrateInstance(parentInstance: Instance | Container, instance: Instance | TextInstance) {
  ...
  didNotFindHydratableInstance(parentInstance: Instance | Container, type: string, props: Props) {
...
function renderSubtreeIntoContainer(parentComponent: ?ReactComponent<any, any, any>, children: ReactNodeList, container: DOMContainer, forceHydrate: boolean, callback: ?Function) {
...
var ReactDOMFiber = {
  hydrate(element: ReactElement<any>, container: DOMContainer, callback: ?Function) {
    // TODO: throw or warn if we couldn't hydrate?
    return renderSubtreeIntoContainer(null, element, container, true, callback);
  },

  render(element: ReactElement<any>, container: DOMContainer, callback: ?Function) {
  ...
  unstable_renderSubtreeIntoContainer(parentComponent: ReactComponent<any, any, any>, element: ReactElement<any>, containerNode: DOMContainer, callback: ?Function) {
    invariant(parentComponent != null && ReactInstanceMap.has(parentComponent), 'parentComponent must be a valid React Component');
  ...
  unstable_createPortal(children: ReactNodeList, container: DOMContainer, key: ?string = null) {
