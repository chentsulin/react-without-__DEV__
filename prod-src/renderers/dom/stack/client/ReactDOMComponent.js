...
function assertValidProps(component, props) {
  ...
  if (voidElementTags[component._tag]) {
    invariant(props.children == null && props.dangerouslySetInnerHTML == null, '%s is a void element tag and must neither have `children` nor ' + 'use `dangerouslySetInnerHTML`.%s', component._tag, getDeclarationErrorAddendum(component));
  }
...
ReactDOMComponent.Mixin = {
  ...
  _updateDOMChildren: function (lastProps, nextProps, transaction, context) {
    ...
    } else if ((lastContent != null || lastHtml != null) && !(nextContent != null || nextHtml != null)) {
