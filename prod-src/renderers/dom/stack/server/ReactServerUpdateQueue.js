...
class ReactServerUpdateQueue {
   ...
   * @internal
   */
  enqueueReplaceState(publicInstance: ReactComponent<any, any, any>, completeState: Object | Function, callback?: Function, callerName?: string) {
    if (this.transaction.isInTransaction()) {
   ...
   * @internal
   */
  enqueueSetState(publicInstance: ReactComponent<any, any, any>, partialState: Object | Function, callback?: Function, callerName?: string) {
    if (this.transaction.isInTransaction()) {
