...
var checkPropTypes, lowPriorityWarning, ReactDebugCurrentFrame, warning, describeComponentFrame, getComponentName, currentlyValidatingElement, getDisplayName, getStackAddendum;
...
function validateChildKeys(node, parentType) {
  ...
  if (Array.isArray(node)) {
    ...
    var iteratorFn = ITERATOR_SYMBOL && node[ITERATOR_SYMBOL] || node[FAUX_ITERATOR_SYMBOL];
