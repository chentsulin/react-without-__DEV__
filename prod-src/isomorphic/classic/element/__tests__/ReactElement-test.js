...
describe('ReactElement', () => {
  ...
  it('should warn when `key` is being accessed on composite element', () => {
    ...
    expectDev(console.error.calls.argsFor(0)[0]).toContain('Child: `key` is not a prop. Trying to access it will result ' + 'in `undefined` being returned. If you need to access the same ' + 'value within the child component, you should pass it as a different ' + 'prop. (https://fb.me/react-special-props)');
  });
  ...
  it('should warn when `key` is being accessed on a host element', () => {
    ...
    expectDev(console.error.calls.count()).toBe(1);
    expectDev(console.error.calls.argsFor(0)[0]).toContain('div: `key` is not a prop. Trying to access it will result ' + 'in `undefined` being returned. If you need to access the same ' + 'value within the child component, you should pass it as a different ' + 'prop. (https://fb.me/react-special-props)');
  });
  ...
  it('should warn when `ref` is being accessed', () => {
    ...
    ReactDOM.render(<Parent />, container);
    expectDev(console.error.calls.count()).toBe(1);
    expectDev(console.error.calls.argsFor(0)[0]).toContain('Child: `ref` is not a prop. Trying to access it will result ' + 'in `undefined` being returned. If you need to access the same ' + 'value within the child component, you should pass it as a different ' + 'prop. (https://fb.me/react-special-props)');
  });
  ...
  it('merges rest arguments onto the children prop in an array', () => {
    ...
    var element = React.createFactory(ComponentClass)(null, 1, 2, 3);
  ...
  it('is indistinguishable from a plain object', () => {
    ...
    expect(element.constructor).toBe({}.constructor);
  });
...
describe('comparing jsx vs .createFactory() vs .createElement()', () => {
  ...
  describe('when using parent that uses .createFactory()', () => {
    ...
    beforeEach(() => {
      ...
      class Parent extends React.Component {
        render() {
          return React.createElement('div', {}, childFactory({ ref: 'child', foo: 'foo value' }, 'children value'));
        }
      }
